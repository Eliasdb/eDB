...
namespace PlatformAPITests.Controllers
{
  public class ApplicationsControllerTests
  {
    ...
    public async Task GetApplications_ReturnsOkWithApplications()
    {
      ...
      _mockApplicationsService.Setup(s => s.GetApplicationsAsync()).ReturnsAsync(expectedApps);
      ...
      var returnedApps = Assert.IsAssignableFrom<IEnumerable<ApplicationDto>>(okResult.Value);
