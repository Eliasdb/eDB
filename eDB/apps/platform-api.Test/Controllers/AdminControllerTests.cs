...
namespace PlatformAPITests.Controllers
{
  public class AdminControllerTests
  {
    ...
    public async Task DeleteApplication_ApplicationExists_ReturnsOk()
    {
      // Arrange
      int applicationId = 1;
      _mockAdminService.Setup(s => s.DeleteApplicationAsync(applicationId)).ReturnsAsync(true);
    ...
    public async Task DeleteApplication_ApplicationNotFound_ReturnsNotFound()
    {
      ...
      _mockAdminService.Setup(s => s.DeleteApplicationAsync(applicationId)).ReturnsAsync(false);
