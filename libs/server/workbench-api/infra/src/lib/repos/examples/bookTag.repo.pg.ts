...
import { booksTable } from '../../db/schemas/examples/schema.books';
import { bookTagsTable } from '../../db/schemas/examples/schema.bookTags';
...
type Extras = {
  ...
  listBooksForTag(tagId: string): Promise<
    {
      id: string;
      title: string;
